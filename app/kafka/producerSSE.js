const  {kafkaSSE}  = require('./kafkaClient');
const { safeJsonStringify } = require('../utils/jsonSecurityUtils');

class KafkaProducerSSE {
    constructor() {
        if (KafkaProducerSSE.instance) {
            return KafkaProducerSSE.instance;
        }
        
        this.producer = null;
        this.connected = false;
        this.connecting = false;
        KafkaProducerSSE.instance = this;
    }
    ...
    async connect() {
        ...
        try {
            ...
            if (!this.producer) {
                this.producer = kafkaSSE.producer({
    ...
    async gracefulShutdown() {
        ...
        KafkaProducerSSE.instance = null;
    }
}
...
module.exports = KafkaProducerSSE;